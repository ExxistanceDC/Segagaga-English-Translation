...
At this time, the only known issue is the spacing of the bluff (i.e., magic spell)
    costs in the Battle Mode bluff menu. Once the spell cost is double digits, they are indented
    farther left than the single digit spell costs. We're still searching for a way to fix 
    this, but it isn’t game-breaking.
